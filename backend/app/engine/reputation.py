"""
reputation.py — Integrated Reputation & Trust Engine (v2.1.2)
===========================================================
...
# ── 2. Absolute Path Resolution (Fix for SEC-04) ──────────────────────────────

# Get the directory where this module is located (backend/app/engine/)
_MODULE_DIR = os.path.dirname(os.path.abspath(__file__))

# Move up two levels to 'backend/' then down into 'data/'
DATA_PATH = os.path.normpath(
    os.path.join(_MODULE_DIR, "..", "..", "data", "tranco_top_100k.csv")
)

# ── 3. Data Loading (Tranco Tier) ─────────────────────────────────────────────
...
# ── 5. Public API (Trust & Threat Checks) ─────────────────────────────────────
